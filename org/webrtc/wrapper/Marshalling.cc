...
#define DEFINE_MARSHALLED_ENUM(name, winuwpType, nativeType)\
	typedef winuwpType name##_winuwpType;\
	typedef nativeType name##_nativeType;\
	std::map<winuwpType, nativeType> name##_enumMap = {
#define DEFINE_MARSHALLED_ENUM_END(name)\
	};\
	void FromCx(name##_winuwpType inObj, name##_nativeType* outObj) {\
		(*outObj) = name##_enumMap[inObj];\
	}\
	void ToCx(name##_nativeType const& inObj, name##_winuwpType* outObj) {\
	...
	throw "Marshalling failed";\
			...
			DEFINE_MARSHALLED_ENUM(StatsValueName,
				...
				{ RTCStatsValueName::StatsValueNameAecDivergentFilterFraction,
					webrtc::StatsReport::kStatsValueNameAecDivergentFilterFraction },
				...
				{ RTCStatsValueName::StatsValueNameFramesDecoded,
					webrtc::StatsReport::kStatsValueNameFramesDecoded },
				{ RTCStatsValueName::StatsValueNameFramesEncoded,
					webrtc::StatsReport::kStatsValueNameFramesEncoded },
				...
				{ RTCStatsValueName::StatsValueNameQpSum,
					webrtc::StatsReport::kStatsValueNameQpSum },
				...
				{ RTCStatsValueName::StatsValueNameSentPingRequestsTotal,
					webrtc::StatsReport::kStatsValueNameSentPingRequestsTotal },
				{ RTCStatsValueName::StatsValueNameSentPingRequestsBeforeFirstResponse,
					webrtc::StatsReport::kStatsValueNameSentPingRequestsBeforeFirstResponse },
				{ RTCStatsValueName::StatsValueNameSentPingResponses,
					webrtc::StatsReport::kStatsValueNameSentPingResponses },
				{ RTCStatsValueName::StatsValueNameRecvPingRequests,
					webrtc::StatsReport::kStatsValueNameRecvPingRequests },
				{ RTCStatsValueName::StatsValueNameRecvPingResponses,
					webrtc::StatsReport::kStatsValueNameRecvPingResponses },
				...
				{ RTCStatsValueName::StatsValueNameDecodingMutedOutput,
					webrtc::StatsReport::kStatsValueNameDecodingMutedOutput },
				...
				{ RTCStatsValueName::StatsValueNameResidualEchoLikelihood,
					webrtc::StatsReport::kStatsValueNameResidualEchoLikelihood },
				{ RTCStatsValueName::StatsValueNameResidualEchoLikelihoodRecentMax,
					webrtc::StatsReport::kStatsValueNameResidualEchoLikelihoodRecentMax },
