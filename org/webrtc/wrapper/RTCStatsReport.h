...
namespace Org {
	namespace WebRtc {
		...
		public enum class RTCStatsValueName {
			...
			StatsValueNameAecDivergentFilterFraction,
			...
			StatsValueNameFramesDecoded,
			StatsValueNameFramesEncoded,
			...
			StatsValueNameSentPingRequestsTotal,
			StatsValueNameSentPingRequestsBeforeFirstResponse,
			StatsValueNameSentPingResponses,
			StatsValueNameRecvPingRequests,
			StatsValueNameRecvPingResponses,
			...
			StatsValueNameDecodingMutedOutput,
			...
			StatsValueNameResidualEchoLikelihood,
			StatsValueNameResidualEchoLikelihoodRecentMax,
